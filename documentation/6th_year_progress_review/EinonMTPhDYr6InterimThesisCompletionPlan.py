...
# # Thesis Outline - thesis 70% complete
...
# * **Chapter 4: Using functional QTL gene annotation to better identify genes associated with disease** - *95% complete*
#
...
# * **Chapter 5: Application of the analysis pipeline to neuropsychiatric diseases** - *20% complete*
#
...
# * **Appendix C: Pipeline scripts** - *30% complete*
