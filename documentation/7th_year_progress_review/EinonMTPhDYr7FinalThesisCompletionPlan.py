...
# # Thesis Outline - thesis 100% complete
...
# * **Chapter 5: Application of the analysis pipeline to neuropsychiatric diseases** - *100% complete*
#
#     * Running the analysis pipeline on several Unknown Diseases
#     * Analyse and interpret the results

# * **Chapter 6: Discussion & conclusions** - *100% complete*
#
...
# * **Appendix C: neuropsychiatric and neurodegenerative disease results** - *100% complete*
#     * Full results as summarised in Chapter 5.

# * **Appendix D: Pipeline scripts** - *100% complete*
