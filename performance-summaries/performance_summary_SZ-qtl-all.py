...
#
# # Schizophrenia (all QTLs) results summary
#
...
#
# Heritability - 79% (https://www.gwern.net/docs/genetics/heritable/2017-hilker.pdf)
...
gene_twas_df = pd.read_csv("../data/wrangling/ST_FUSION_results.csv", sep="\t")[
    ["ID", "Gene", "TWAS.Z"]
]
...
#
#  * Blue dots are ATC code N05Axxx - ANTIPSYCHOTICS
